...
__published:	// IDE-managed Components
	...
	void __fastcall SemuaData1Click(TObject *Sender);
	void __fastcall SemuaData2Click(TObject *Sender);
private:	// User declarations
public:		// User declarations

    //mendeklarasikan komponen-komponen atau variabel untuk digunakan ke form
